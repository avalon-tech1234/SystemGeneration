...
\newcommand{\AuthorFullDat}{Момоту Даниэлю Михайловичу} % Фамилия Имя Отчество автора в дательном падеже (Кому?) 
\newcommand{\Supervisor}{И.О.\,Фамилия} % И. О. Фамилия научного руководителя
\newcommand{\SupervisorDegree}{должность, степень} % 
%%
%%
\newcommand{\Head}{К.А.\,Туральчук} % И. О. Фамилия руководителя подразделения (руководителя ОП)
\newcommand{\HeadDegree}{Старший }% Только должность:   
%Руководитель ОП 
%Заведующий кафедрой
...
%%
%%
\renewcommand{\thesisTitle}{Название выпускной квалификационной работы}
\newcommand{\thesisDegree}{бакалавра}% магистра или специалиста
\newcommand{\thesisTitleEn}{Title of the thesis} %2020
\newcommand{\thesisDeadline}{дд.мм.гггг}
\newcommand{\thesisStartDate}{дд.мм.гггг}
